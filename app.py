تفضل يا عمر، لقد قمت بتجهيز الكود النهائي ودمج كافة المميزات الرائعة التي طلبتها بدقة.
تمت إضافة نظام الإشعارات للإدارة، وتحديث شكل زر "اخبار الفلوس" ليظهر في جميع الرسائل مع الملصقات المميزة، وإضافة زر الدعوة للمجموعات، وبرمجة نظام حفظ المعلومات الخاص بالمستخدمين (معلوماتي و اضافة معلومات)، بالإضافة إلى تنسيق قائمة الأوامر وتتبع دخول البوت للمجموعات.
إليك الكود الشامل والمحدث:
```python
import os
import time
import aiohttp
